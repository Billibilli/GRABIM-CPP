...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=PRF957_Input.dat>
  <DataDisplay=PRF957_Input.dpl>
  <OpenDisplay=0>
  <Script=PRF957_Input.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <Pac P1 1 10 430 18 -26 0 1 "1" 1 "50 Ohm" 1 "-5 dBm" 0 "1 GHz" 0 "26.85" 0>
  <SPfile X1 1 180 380 -26 -67 0 0 "/home/andresmmera/git/GRABIM-CPP/testbench/Spar_BFG310WXR_3V5mA.s2p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
